$(function() {
		...
		dataView.setGrouping([
				{
					...
					aggregators : [ new Slick.Data.Aggregators.Sum("duration"), new Slick.Data.Aggregators.Sum("cost") ],
				...
				},
				{
					getter : "effortDriven",
					formatter : function(g) {
						return "Effort-Driven:  " + (g.value ? "True" : "False") + "  <span style='color:green'>(" + g.count
								+ " items)</span>";
					},
					aggregators : [ new Slick.Data.Aggregators.Avg("percentComplete"), new Slick.Data.Aggregators.Sum("cost") ],
					collapsed : true,
	...
	$(function() {
		...
		// register the group item metadata provider to add expand/collapse group
		// handlers
		...
		grid.onSort.subscribe(function(e, args) {
			...
			if ($.browser.msie && $.browser.version <= 8) {
				...
				// more limited and does lexicographic sort only by default, but can be
				// much faster
